...
.kb-calc{background:#fffdf8;border:1px solid var(--line);border-radius:12px;padding:20px 22px;margin:24px 0}
.kb-calc-row{display:flex;align-items:center;gap:12px;margin-bottom:14px}
.kb-calc-row label{flex:1;font-size:15px;color:var(--lead)}
.kb-calc-num{width:120px;font-size:15px;padding:8px 10px;border:1px solid #E0D6C2;border-radius:8px;background:#fff;color:var(--ink)}
.kb-calc-row input[type=range]{flex:1;accent-color:var(--accent)}
.kb-calc-val{width:56px;text-align:right;font-weight:600;color:var(--ink)}
.kb-calc-results{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:10px;margin-top:6px}
.kb-calc-card{background:var(--bg);border:1px solid var(--line);border-radius:10px;padding:12px 14px}
.kb-calc-label{font-size:12px;color:var(--muted)}
.kb-calc-figure{font-size:22px;font-weight:600;color:var(--ink);margin-top:2px}
.kb-calc-card.kb-calc-hl{background:#FBE5D3;border-color:#F0C998}
.kb-calc-card.kb-calc-hl .kb-calc-label,.kb-calc-card.kb-calc-hl .kb-calc-figure{color:var(--accent-ink)}
.kb-calc-note{font-size:12px;color:var(--muted);margin-top:14px}
