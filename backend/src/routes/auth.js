...
router.post('/magic-link', async (req, res, next) => {
  try {
    ...
    // Flat keys, no prefix (per the CRM dev team). Empty fields omitted.
    ...
    deliveryPayload.user_id   = userId;
    deliveryPayload.token     = token;
    deliveryPayload.login_url = loginUrl;
