      ...
      <nav className="flex-1 px-3 py-4 flex flex-col gap-0.5 overflow-y-auto">
        ...
        {isAdmin && (
          <>
            ...
            <SidebarItem to="/admin/page-views"       icon={<PageViewsIcon />} label="Page Views"      active={active('/admin/page-views')} />
...
function PageViewsIcon() { return I(<><path d="M3 3v18h18"/><path d="M18 17V9"/><path d="M13 17V5"/><path d="M8 17v-3"/></>); }
