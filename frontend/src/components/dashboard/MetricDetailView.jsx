...
const METRIC_CONFIG = {
  ...
  play_rate: {
    label: 'Play Rate', yLabel: 'Play Rate %',
    backendKey: 'play_rate', accentColor: '#c084fc',
    desc: 'Percentage of embed page loads where the viewer actually pressed play.',
    formula: 'Play Rate = Play sessions ÷ Total Page Load sessions × 100',
    totalLabel: 'Period Avg.',
    format: n => `${Number(n).toFixed(1)}%`,
    yTickFormat: n => `${Number(n).toFixed(0)}%`,
  },
