...
// ─────────────────────────────────────────────────────────────────────────
// ComingSoonSection — roadmap feature tiles shown on the dashboard
// ─────────────────────────────────────────────────────────────────────────
...
const COMING_FEATURES = [
  {
    ...
    name: 'Funnels',
    desc: 'Track viewer progression through multi-step video sequences and identify where drop-offs occur across your funnel.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    name: 'Events',
    desc: 'Define custom events at specific timestamps — CTAs, chapters, form submissions — and track viewer interactions.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    name: 'Reports',
    desc: 'Schedule and export detailed analytics reports — weekly digests, comparison periods, audience breakdowns.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    name: 'Alerts',
    desc: 'Get notified when a video hits a milestone, drops below a threshold, or a viewer completes a key moment.',
  },
];
    ...
    <div className="mt-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {COMING_FEATURES.map(feature => (
          <div
            key={feature.name}
            className="bg-gray-800/30 border border-gray-700/40 rounded-xl p-4 opacity-70"
          >
            <div className="flex items-center gap-3 mb-2">
              <span className="text-gray-500 flex-shrink-0">{feature.icon}</span>
              <span className="text-sm font-semibold text-gray-300">{feature.name}</span>
              <span className="ml-auto text-[9px] bg-gray-700/60 text-gray-500 px-2 py-0.5 rounded-full uppercase tracking-wider flex-shrink-0">
                Soon
              </span>
            </div>
